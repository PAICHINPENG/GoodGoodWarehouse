...
<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="margin-left:27%; margin-top: 10%;">
  <li class="nav-item">
  ...
  <form action="upload_product.php" id="pform" method="post" enctype="multipart/form-data">
    <fieldset>
      ...
      <div class="field-wrapper">
        <label for="product_name" style="margin-left:2px">商品名稱</label>
        <input type="text" name="product_name" style="width: 75%" id="name" class="form-element" required autocomplete="name" placeholder="Proudct Name"><br><br><br>
        <label for="product_depict" style="margin-left:2px">商品描述</label>
        ...
        <label for="product_price" style="margin-left:2px">商品金額</label>
        ...
        <label for="product_stock" style="margin-left:2px">剩餘庫存</label>
        ...
        <label for="type" style="margin-left:2px">商品種類</label>
        <select class="form-element" style="width: 75%"  name="product_type">
          ...
          <label for="Image" style="margin-left:2px">商品圖片</label>
